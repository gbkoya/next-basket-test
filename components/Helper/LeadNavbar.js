    ...
    <div className="w-full bg-white font-montserrat">
      <nav className="fixed top-0 w-full z-[50]">
        <div className="lg:block hidden">
          <div className="h-12 bg-[#23856D] text-white px-5 flex justify-between items-center font-montserrat">
            <div className="flex">
        ...
        <div className="lg:py-4 py-8 h-12  px-5 flex  items-center bg-white">
          {/* Logo */}
          ...
          <div className="hidden md:flex justify-end items-center w-full text-[#23A6F0] font-montserrat">
            ...
            <div className="mx-2 flex items-center"><CiHeart className="text-lg" /><span className="text-sm">1</span></div>
          </div>
        </div>
        ...
        {/* Responsive Drawer (Visible on Small and Medium screens) */}
        {
          isDrawerOpen && (
            <div className="md:hidden pt-8 bg-white text-center font-montserrat p-4">
              ...
              <Link href="/about">
                <div className="block text-[#737373] text-3xl  font-extralight mb-4">Product</div>
              </Link>
              <Link href="/search">
                <div className="block text-[#737373] text-3xl font-normal mb-4">Pricing</div>
              </Link>
              <Link href="/joinus">
